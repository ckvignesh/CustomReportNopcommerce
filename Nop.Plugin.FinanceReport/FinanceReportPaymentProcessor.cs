...
namespace Nop.Plugin.FinanceReport
{
    ...
    /// </summary>
    public class FinanceReportPaymentProcessor : BasePlugin,  IAdminMenuPlugin
    {
        #region Fields
       ...
       // private readonly FinanceReportPaymentSettings _eNETSPaymentSettings;
        ...
        public FinanceReportPaymentProcessor(ILocalizationService localizationService,
            IOrderTotalCalculationService orderTotalCalculationService,
            ISettingService settingService,
            IWebHelper webHelper,
            //FinanceReportPaymentSettings eNETSPaymentSettings,
        ...
        public async Task PostProcessPaymentAsync(PostProcessPaymentRequest postProcessPaymentRequest)
        {
           ...
           // string hmac = GenerateSignature(req, _eNETSPaymentSettings.SecretKey);
            ...
            var transactionLog = new FinanceReportransactionLog()
            {
        ...
        {
            return $"{_webHelper.GetStoreLocation()}Admin/FinanceReport/Configure";
        }
        ...
        public override async Task InstallAsync()
        {
            ...
            //add permission
            await _permissionService.InstallPermissionsAsync(new FinanceReportPermission());

            ////locales
            //await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
            //{
            //    ["Plugins.FinanceReport.Instructions"] = "",
            //    ["Plugins.FinanceReport.Fields.AdditionalFee"] = "Additional fee",
            //    ["Plugins.FinanceReport.Fields.AdditionalFee.Hint"] = "Enter additional fee to charge your customers.",
            //    ["Plugins.FinanceReport.Fields.AdditionalFeePercentage"] = "Additional fee. Use percentage",
            //    ["Plugins.FinanceReport.Fields.AdditionalFeePercentage.Hint"] = "Determines whether to apply a percentage additional fee to the order total. If not enabled, a fixed value is used.",
            //    ["Plugins.FinanceReport.Fields.TransactMode"] = "After checkout mark payment as",
            //    ["Plugins.FinanceReport.Fields.TransactMode.Hint"] = "Specify transaction mode.",
            //    ["Plugins.FinanceReport.PaymentMethodDescription"] = "You will be redirected to eNETS site to complete the order.",
            //    ["Plugins.FinanceReport.PaymentModeCC"] = "Credit Card",
            //    ["Plugins.FinanceReport.PaymentModeDD"] = "Direct Debit",
            //    ["Plugins.FinanceReport.PaymentModeQR"] = "QR Code",
            //    ["Plugins.FinanceReport.Company"] = "SingHealth"
            //});
        ...
        {
            //settings
           // await _settingService.DeleteSettingAsync<FinanceReportPaymentSettings>();

            //locales
            await _localizationService.DeleteLocaleResourcesAsync("Plugins.FinanceReport");

            //delete permission
            //if (await _permissionService.AuthorizeAsync(FinanceReportPermission.FinanceReport))
            //{
            //    var permissionRecord = (await _permissionService.GetAllPermissionRecordsAsync())
            //        .FirstOrDefault(x => x.SystemName == FinanceReportPermission.FinanceReport.SystemName);
        ...
        {
            return await _localizationService.GetResourceAsync("Plugins.FinanceReport.PaymentMethodDescription");
        }
