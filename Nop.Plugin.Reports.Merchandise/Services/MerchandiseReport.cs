    ...
    public class MerchandiseReport : IMerchandiseReport
    {
        ...
        public virtual async Task<byte[]> ExportMerchadiseReportToXlsxAsync(IEnumerable<MerchandiseTransactionLog> report)
        {
            ...
            var properties = new[]
            {
                ...
                new PropertyByName<MerchandiseTransactionLog>("Product SKU",p => p.SKU),
                ...
                new PropertyByName<MerchandiseTransactionLog>("Product Launch Date (SGT)",p => p.ProductLaunchDate),
                ...
                new PropertyByName<MerchandiseTransactionLog>("Promotion Start Date (UTC)",p => p.PromotionStartDate),
                new PropertyByName<MerchandiseTransactionLog>("Promotion End Date (UTC)",p => p.PromotionEndDate),
